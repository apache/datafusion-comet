...
# The Delta contrib suites are queue-only, with their own label.
DELTA_OPT_IN = {"delta"}
# The queue adds one Spark version (4.1, the default profile) and one Iceberg
# version (1.11, the only Spark 4.1 coverage), plus the build-level gates and
# the Delta contrib suites.
QUEUE_TIER = PR_TIER | {
    "spark_4_1",
    "spark_4_1_hive",
    "iceberg_1_11",
...
POLICY_CASES = [
    ...
    # The Delta contrib suites are queue-only too, with their own label as
    # the escape hatch.
    (
