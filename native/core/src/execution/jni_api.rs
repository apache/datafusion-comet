...
pub unsafe extern "system" fn Java_org_apache_comet_Native_createPlan(
    ...
    try_unwrap_or_throw(&e, |env| {
        ...
        with_trace("createPlan", tracing_enabled, || {
            ...
            // Register the shared base pool before wrapping it for the real-usage gate or
            // per-plan debug logging. The guard removes the entry if any later plan setup step
            // fails.
