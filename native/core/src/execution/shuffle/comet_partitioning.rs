...
pub enum CometPartitioning {
    ...
    /// Distributes rows evenly across output partitions in round-robin fashion.
    /// Args are 1) the number of partitions, 2) the starting position offset for determinism.
