...
fn main() {
    ...
    if let Ok(out_dir) = std::env::var("OUT_DIR") {
        ...
        // The corresponding artifact dir is .../target/<profile>
    ...
    println!("cargo:rerun-if-changed=../test-udfs/src/lib.rs");
    println!("cargo:rerun-if-changed=../test-udfs/Cargo.toml");
}
