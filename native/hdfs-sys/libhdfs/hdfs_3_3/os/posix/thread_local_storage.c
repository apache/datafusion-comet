 ...
 * full list of modifications. The changes here are the HDFS-16021
 * thread-ownership guard in hdfsThreadDestructor and the initialisation of the
 * two fields threadLocalStorageCreate previously left uninitialised.
 */
