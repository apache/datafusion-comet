...
lazy val native = (project in file("native"))
  ...
  .settings(
    ...
    copyNativeLibs := {
      ...
      val sourceDir = baseDirectory.value / "target" / (ThisBuild / rustTarget).value / (if (buildType == "release") "release" else "debug")
...
lazy val common = (project in file("common"))
  ...
  .settings(
    ...
    Compile / unmanagedSourceDirectories ++=
      sparkVersionSpecificSources((ThisBuild / sparkVersion).value, (Compile / sourceDirectory).value),
...
lazy val spark = (project in file("spark"))
  ...
  .settings(
    ...
    Test    / unmanagedSourceDirectories ++=
      sparkVersionSpecificSources((ThisBuild / sparkVersion).value, baseDirectory.value / "src" / "test"),
