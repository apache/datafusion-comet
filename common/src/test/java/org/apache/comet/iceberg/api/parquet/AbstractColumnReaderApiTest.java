...
/** Tests for the AbstractColumnReader public API. */
public class AbstractColumnReaderApiTest extends AbstractApiTest {

  @Test
  public void testAbstractColumnReaderHasIcebergApiAnnotation() {
    assertThat(hasIcebergApiAnnotation(AbstractColumnReader.class)).isTrue();
  }

  @Test
  public void testAbstractColumnReaderIsPublic() {
    assertThat(isPublic(AbstractColumnReader.class)).isTrue();
  }

  @Test
  public void testAbstractColumnReaderIsAbstract() {
    assertThat(Modifier.isAbstract(AbstractColumnReader.class.getModifiers())).isTrue();
  }
  ...
  @Test
  public void testNativeHandleFieldType() throws NoSuchFieldException {
    Field field = AbstractColumnReader.class.getDeclaredField("nativeHandle");
