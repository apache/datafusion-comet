...
-- 4.2 yet, so the build reuses the 4.0 runtime, which is binary-incompatible with 4.2 (e.g.
-- connector.catalog.View became a class). Mirrors the assume(!isSpark42Plus) guard in
-- CometIcebergNativeSuite. See https://github.com/apache/datafusion-comet/issues/4969.
-- MaxSparkVersion: 4.1
