...
statement
CREATE TABLE test_time_range_shuffle(hours int, minutes int, secs decimal(16,6)) USING parquet

statement
INSERT INTO test_time_range_shuffle VALUES
