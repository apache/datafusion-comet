...
query expect_fallback(next_day: spark.comet.exec.scalaUDF.codegen.enabled=false)
...
query expect_fallback(convert_timezone: spark.comet.exec.scalaUDF.codegen.enabled=false)
...
query expect_fallback(make_timestamp: spark.comet.exec.scalaUDF.codegen.enabled=false)
SELECT make_timestamp(2024, 6, 15, 12, 0, 0, zone COLLATE UTF8_LCASE) FROM routing_datetime_collation

query expect_fallback(to_unix_timestamp: spark.comet.exec.scalaUDF.codegen.enabled=false)
