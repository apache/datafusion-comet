...
statement
INSERT INTO test_hour VALUES (timestamp('2024-01-15 00:00:00')), (timestamp('2024-01-15 12:30:45')), (timestamp('2024-01-15 23:59:59')), (timestamp('1969-12-31 23:59:59')), (NULL)
...
statement
CREATE TABLE test_hour_ntz(ts timestamp_ntz) USING parquet

statement
INSERT INTO test_hour_ntz VALUES (cast('2024-01-15 00:00:00' as timestamp_ntz)), (cast('2024-01-15 12:30:45' as timestamp_ntz)), (cast('2024-01-15 23:59:59' as timestamp_ntz)), (cast('1969-12-31 23:59:59' as timestamp_ntz)), (NULL)

query
SELECT hour(ts) FROM test_hour_ntz
