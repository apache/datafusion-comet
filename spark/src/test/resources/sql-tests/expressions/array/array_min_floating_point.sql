...
statement
CREATE TABLE test_array_min_floating_point(id int, d array<double>, f array<float>) USING parquet

statement
INSERT INTO test_array_min_floating_point VALUES
...
query
SELECT id, array_min(d), array_min(f) FROM test_array_min_floating_point
...
query
SELECT array_min(CAST(NULL AS array<double>)),
       array_min(CAST(NULL AS array<float>)),
       array_min(CAST(array() AS array<double>)),
       array_min(CAST(array() AS array<float>)),
       array_min(array(CAST(NULL AS double), CAST(NULL AS double))),
       array_min(array(CAST(NULL AS float), CAST(NULL AS float)))

query
SELECT array_min(array(double('NaN'), double('Infinity'), double('-Infinity'))),
       array_min(array(float('NaN'), float('Infinity'), float('-Infinity'))),
       array_min(array(double('NaN'), double('NaN'))),
       array_min(array(float('NaN'), float('NaN'))),
       array_min(array(double('Infinity'), double('-Infinity'))),
       array_min(array(float('Infinity'), float('-Infinity')))
...
query
SELECT n, negative_first, array_min(d), array_min(f),
       array_min(nullable_d), array_min(nullable_f)
FROM test_array_min_floating_long
...
statement
CREATE TABLE test_array_min_floating_nested(
  id int, d array<array<double>>, f array<array<float>>) USING parquet

statement
INSERT INTO test_array_min_floating_nested VALUES
...
query
SELECT id, array_min(d), array_min(f) FROM test_array_min_floating_nested
...
statement
CREATE TABLE test_array_min_floating_struct(
  id int, d array<struct<v:double,payload:int>>, f array<struct<v:float,payload:int>>) USING parquet

statement
INSERT INTO test_array_min_floating_struct VALUES
...
query
SELECT id, array_min(d), array_min(f) FROM test_array_min_floating_struct
...
FROM test_array_min_floating_struct WHERE id IN (1, 2, 3, 4)
