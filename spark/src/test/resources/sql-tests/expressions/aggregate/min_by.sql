...
-- depends on the inter-partition merge order, and this table spans several partitions, so min_by is
...
statement
CREATE TABLE mnb_signed_zero(v int, ord double, grp string) USING parquet

statement
INSERT INTO mnb_signed_zero VALUES
