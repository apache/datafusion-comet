...
import org.apache.spark.sql.catalyst.expressions.{AttributeReference, DynamicPruningExpression, Expression, ExpressionInfo, Hex, Literal}
...
class CometExecSuite extends CometTestBase {
  ...
  private def emptyRelation(
      output: Seq[org.apache.spark.sql.catalyst.expressions.Attribute]): SparkPlan = {
  ...
  private def localTableScan(
      output: Seq[org.apache.spark.sql.catalyst.expressions.Attribute]): LocalTableScanExec =
