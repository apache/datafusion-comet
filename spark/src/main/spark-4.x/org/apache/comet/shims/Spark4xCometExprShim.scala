...
import org.apache.comet.serde.{CometAggregateExpressionSerde, CometExpressionSerde, CometHllSketchAgg, CometHllSketchEstimate, CometMapSort, CometToPrettyString, CometWidthBucket}
...
trait Spark4xCometExprShim extends CometExprShim4x {
  ...
  def sparkVersionSpecificAggregates: Map[Class[_], CometAggregateExpressionSerde[_]] =
    Map(classOf[HllSketchAgg] -> CometHllSketchAgg)
