...
/**
 * Comet's Arrow Python runner for scalar Python UDFs on Spark 4.1. The Arrow IPC exchange lives
 * in [[CometArrowPythonRunnerBase]]; this subclass only supplies the Spark 4.1 constructor shape
