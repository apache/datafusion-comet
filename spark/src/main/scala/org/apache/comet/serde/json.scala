...
import org.apache.spark.sql.catalyst.expressions.{Attribute, Expression, StructsToJson}
...
object CometStructsToJson extends CometExpressionSerde {
  ...
  override def convert(
    ...
    expr match {
      ...
      case _ =>
        withInfo(expr, s"Unexpected expression type for CometStructsToJson: ${expr.getClass}")
        None
    }
  }
}
