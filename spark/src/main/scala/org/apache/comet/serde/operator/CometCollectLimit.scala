...
import org.apache.spark.sql.comet.{CometCollectLimitExec, CometNativeExec, CometSinkPlaceHolder}
...
object CometCollectLimit extends CometSink[CollectLimitExec] {
