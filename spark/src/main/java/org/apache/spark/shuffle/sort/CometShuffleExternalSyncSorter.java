...
/**
 * An external sorter that is specialized for sort-based shuffle with synchronous spilling.
 *
 ...
 *
 * <p>This sorter writes spill files synchronously. When spilling is triggered, it blocks the
 * current thread to write the sorted data to disk, then reuses the same in-memory sorter for
 * continued buffering. For asynchronous spilling, use {@link CometShuffleExternalAsyncSorter}.
 */
public final class CometShuffleExternalSyncSorter
    implements CometShuffleChecksumSupport, CometShuffleExternalSorter {

  private static final Logger logger =
      LoggerFactory.getLogger(CometShuffleExternalSyncSorter.class);
  ...
  public CometShuffleExternalSyncSorter(
