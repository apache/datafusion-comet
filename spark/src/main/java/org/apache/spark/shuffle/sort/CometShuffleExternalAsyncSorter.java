...
/**
 * An external sorter that is specialized for sort-based shuffle with asynchronous spilling.
 *
 ...
 */
public final class CometShuffleExternalAsyncSorter
    implements CometShuffleChecksumSupport, CometShuffleExternalSorter {

  private static final Logger logger =
      LoggerFactory.getLogger(CometShuffleExternalAsyncSorter.class);
  ...
  public CometShuffleExternalAsyncSorter(
  ...
  public void spill() throws IOException {
    ...
    Callable<Void> task =
        () -> {
          ...
          synchronized (CometShuffleExternalAsyncSorter.this) {
