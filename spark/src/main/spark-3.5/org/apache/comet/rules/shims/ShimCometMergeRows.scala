...
/**
 * `MergeRowsExec` (the row-level MERGE dispatch operator) exists on Spark 3.5+; this registers it
 * for Spark 3.5. See `org.apache.comet.serde.operator.CometMergeRows` for the conversion logic.
 */
