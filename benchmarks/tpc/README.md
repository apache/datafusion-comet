...
| ------ | ----- | -------- |
| Standalone | This page | Direct Spark standalone cluster |
| Docker Compose | [docs/docker.md](docs/docker.md) | Isolated local cluster via containers |
| Kubernetes | [docs/kubernetes.md](docs/kubernetes.md) | Spark on K8s with S3 results |
