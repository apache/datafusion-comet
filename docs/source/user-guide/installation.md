...
| Spark Version | Java Version | Scala Version   | Tested in CI |
| ------------- | ------------ | --------------- | ------------ |
| 3.4.3         | 8/11/17      | Scala 2.12/2.13 | Yes          |
| 3.5.4         | 8/11/17      | Scala 2.12/2.13 | Partially    |
| 3.5.5         | 8/11/17      | Scala 2.12/2.13 | Yes          |
...
| Spark Version  | Java Version | Scala Version | Tested in CI |
| -------------- | ------------ | ------------- | ------------ |
| 4.0.0-preview1 | 11/17        | Scala 2.13    | Yes          |
