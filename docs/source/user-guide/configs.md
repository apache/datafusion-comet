...
| spark.comet.coalesceBatches | When enabled, a CoalesceBatchesExec will be inserted into the plan after some operators that can produce smaller batches. | false |
