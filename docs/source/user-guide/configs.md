...
| spark.comet.cast.coalesceBatches | When enabled, a CoalescedBatchExec will be inserted into the plan after some operators that can produce smaller batches. | false |
