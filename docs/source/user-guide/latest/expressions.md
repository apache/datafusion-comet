...
| `unix_timestamp` | ✅ | Hybrid | String parsing uses Spark's codegen and honors the time parser policy, ANSI mode, and session time zone. Date and timestamp inputs use native execution. |
| `weekday` | ✅ | Native |  |
| `weekofyear` | ✅ | Native |  |
