...
| `fs.azure.account.keyprovider`               | Loads an account key provider class                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `fs.azure.account.oauth2.refresh.token`      | Refresh-token OAuth flow                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `fs.azure.account.oauth2.user.name`          | User name and password OAuth flow                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `fs.azure.account.oauth2.user.password`      | User name and password OAuth flow                                                                                                                                                                                                                                                                                                                                                                                                                                            |
