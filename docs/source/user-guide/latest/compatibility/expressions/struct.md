...
The following incompatibilities cause `StructsToJson` to fall back to Spark by default. Set `spark.comet.expression.StructsToJson.allowIncompatible=true` to enable Comet acceleration despite these differences.
