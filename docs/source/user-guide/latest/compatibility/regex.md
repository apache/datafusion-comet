...
endpoints, and counted, aggregate, nested-group, or nested-quantifier patterns that exceed a
conservative compile-size budget stay on the Java engine. Any unrecognized construct also stays
on the Java engine.
