...
| Type          | Status | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `VariantType` | ⚠️     | Spark 4.0+. Direct, top-level whole-value projection (e.g. `SELECT v FROM t`) runs through Comet's native Parquet scan. On Spark 4.1+ this additionally requires `spark.sql.variant.pushVariantIntoScan=false` (an internal Spark conf that defaults to `true` there): with the default, Spark rewrites Variant columns into a pushed `VariantStruct` that Comet does not yet support, so such scans fall back to Spark. Variant expressions, nested Variant, shredded writes, and the pushed-struct rewrite remain fallbacks — tracked by [#4295](https://github.com/apache/datafusion-comet/issues/4295), [#5438](https://github.com/apache/datafusion-comet/issues/5438), and [#3983](https://github.com/apache/datafusion-comet/issues/3983). |
