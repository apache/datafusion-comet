...
| `spark.comet.scan.allowIncompatible` | Some Comet scan implementations are not currently fully compatible with Spark for all datatypes. Set this config to true to allow them anyway. For more information, refer to the [Comet Comet Compatibility Guide Guide] (https://datafusion.apache.org/comet/user-guide/compatibility.html). | false |
...
| `spark.comet.expression.allowIncompatible` | Comet is not currently fully compatible with Spark for all expressions. Set this config to true to allow them anyway. For more information, refer to the [Comet Comet Compatibility Guide Guide] (https://datafusion.apache.org/comet/user-guide/compatibility.html). | false |
...
| `spark.comet.regexp.allowIncompatible` | Comet is not currently fully compatible with Spark for all regular expressions. Set this config to true to allow them anyway. For more information, refer to the [Comet Comet Compatibility Guide Guide] (https://datafusion.apache.org/comet/user-guide/compatibility.html). | false |
<!--END:CONFIG_TABLE-->
...
| `spark.comet.exec.memoryPool` | The type of memory pool to be used for Comet native execution when running Spark in off-heap mode. Available pool types are `greedy_unified` and `fair_unified`. For more information, refer to the [Comet Comet Tuning Guide Guide] (https://datafusion.apache.org/comet/user-guide/tuning.html). | fair_unified |
