...
against each Iceberg version. Iceberg 1.8.1, 1.9.1, and 1.10.0 run against Spark 3.5.9 with Java 17;
Iceberg 1.11.0 runs against Spark 4.1.3 with Java 17. Iceberg 1.11
